...
<p align="center">
  <picture>
    ...
    <img alt="Логотип проекта" src="./media/logo-light.png" width="512" height="auto">
  </picture>
</p>
...
<h1 align="center"> 
Гайд по установке и настройке 3x-ui + SSL-сертификат
</h1>

<h2 align="center">
> 💡 Материал ориентирован для подготовленных пользователей.
</h2>
...
Открываем панель выбора версий и обновлений
...
Переходим в `настройки` и включаем подписку
...
Переходим `настройки X-Ray` -> выбираем `Основные` -> открываем подпункт `Базовые соединения`
...
Переходим `настройки X-Ray` -> выбираем `DNS` -> открываем подпункт `DNS`
